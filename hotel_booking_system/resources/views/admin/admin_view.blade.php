        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="{{route('add_hotel')}}">Add hotels</a></li>
              <li><a href="{{route('view_hotel')}}">View all Hotels</a></li>
              <li><a href="{{route('add_room_type')}}">Add Room Type</a></li>

              

              <div id="navbar-search-autocomplete">
                <input type="search" id="country_name" class="form-control" />
              </div>
              <button type="button" id="search_id" class="btn btn-primary" data-mdb-ripple-init style="height: 35px;"><i class="fas fa-search"></i>
              </button>
...
<script>
  $(document).ready(function() {
    ...
    $("#search_id").on('click', function() {
      var search_name = $('#country_name').val();
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.hasOwnProperty('message') && response.message === 'No country exiting') {
            // Handle case where no data is found
            alert('No cities exiting ' + search_name);
          }
          else {
          var responseString = "Cities in " + search_name + ":\n\n";
          for (var i = 0; i < response.length; i++) {
            responseString += ('*') + " " + response[i].name + "\n";
          }
