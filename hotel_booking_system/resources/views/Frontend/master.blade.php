...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8">
          <ul class="info">
            <li><i class="fa fa-envelope"></i>yadulive333@gmail.com</li>
            <li><i class="fa fa-map"></i>Mumbai</li>
          </ul>
        </div>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a href="properties.html">Booking</a></li>
                      <li><a href="property-details.html">Login/Register</a></li>
                      <li><a href="contact.html">Contact Us</a></li>

                      <div id="navbar-search-autocomplete">
                <input type="text" id="hotel_name" class="form-control" />
              </div>
              <button type="button" id="search_hotel" class="btn btn-primary" data-mdb-ripple-init style="height: 35px;"><i class="fas fa-search"></i>
              </button>
                  </ul>  
  ...
  <div class="main-banner">
    <div class="owl-carousel owl-banner">
      ...
      <div class="item item-2">
        <div class="header-text">
          <h2>Our services Available in Below Countries</h2>
          <ul id="country_names"></ul>
        </div>
      </div>
  ...
  <script>
   $(document).ready(function() {
    var countries_id = $("#country_names");
    console.log("hi",countries_id);
    $.ajax({
            url: "/get-country",
            type: "get",
            success: function(data) {
              var countries = data['available countries'];
              countries.forEach(function(country) {                
                console.log("valuesss",country);
                countries_id.append($("<li>" + country + "</li>"));               
              });
            },
     ...
     $("#search_hotel").on('click',function(e){
      e.preventDefault();  
         ...
         $.ajax({
             ...
             success:function(data) {
              ...
              console.log(data);
              alert("No.of result found" + data.count);
              } else {
                alert("No result found for " + hotel_name);
              }
        ...
        // You can add more AJAX requests here if needed
    });
    </script>
</html>